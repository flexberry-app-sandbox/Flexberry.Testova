...
moduleForModel('i-i-s-testova-производитель', 'Unit | Serializer | i-i-s-testova-производитель', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-testova-производитель',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
    ...
    'model:i-i-s-testova-материал',
    'model:i-i-s-testova-оказание-услуг',
    'model:i-i-s-testova-производитель',
    'model:i-i-s-testova-состав-услуги',
